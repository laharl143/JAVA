...
public class Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Now, the dealer will draw five cards. Press <enter> to draw each card.");
        for (int i = 1; i <= 5; i++) {
            scan.nextLine();
...
/*
final output:
Let's play Pokerito. Press <enter> when you're ready.
...
Now, the dealer will draw five cards. Press <enter> to draw each card.
