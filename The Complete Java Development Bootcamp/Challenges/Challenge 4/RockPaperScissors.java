...
public class RockPaperScissors {
    ...
    */
        if (playerReady.equals("yes")) {
            ...
            System.out.println("\nDarn, some other time...! Game shutting down..");
            System.exit(0);
        }
        String computerChoice = computerChoice(); //getting the computer choice
    ...
    public static String computerChoice() {
        double randomNumber = Math.random() * 3;  //makes a double random number from 0-2
        int roundedRandomNumber = (int)randomNumber; //converts double to int

        switch (roundedRandomNumber) {
        case 0: return "rock";
        case 1: return "paper";
